...
int main() {
    ...
    double fedWholdRate = 0.0;
    double grossPay = 0.0;
    double ficaDedux = 0.0;
    double fedTaxWhold = 0.0;
    double totalDedux = 0.0;
    double netPay = 0.0;
    ...
    cin >> hourlyRate;
    cout << "Enter the federal Tax withhold rate (enter percentage as decimal, for example: 17% = 0.17): ";
    cin >> fedWholdRate;
