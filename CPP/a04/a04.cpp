/****--------------------------------------------------------------------------
   ...
   Description: This program shows the menu of product prices in a Ferry for 
                different groups of people, calculates and outputs the cost of
                an individual or a group of less than 20 people, and gives a
                discount for next Ferry trip for one adult if the price paid is
                $100 or more and offers the remaining balance from obtaining a
                free ticket if bill is less than 100.
   Inputs:      response as a character. numBikes, numAdults, numSeniors,
                numYouths as integers.
   Outputs:     menu as a string, totalCharge, and discount as doubles.
   -----------------------------------------------------------------------****/
        ...
        if (allPeople > 20) {
            ...
            if (numAdults < 0 || numSeniors < 0 || numYouths < 0){
                ...
                if (totalCharge >= 100) {
                    ...
                    discount = 100 - totalCharge;
                    cout << "Spend $" << discount << " more and get a FREE adult ticket for your next trip." << endl;
                }
            }
        }
    }
